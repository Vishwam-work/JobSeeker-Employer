...
import {  Search,Settings,HelpCircle,LogOut, User,Activity,CreditCard,ChevronDown } from "lucide-react";
    ...
    const fetchCompanyDetails = async () => {
      try {
        ...
        //  console.log("Company Details:", data);
          ...
          company_logo: data.company_logo ? process.env.NEXT_PUBLIC_URL + data.company_logo : "",
        });
      } catch (err) {
        console.error(err);
      } finally {
          ...
          <div className="flex items-center gap-4">
            ...
            {/* <div className="relative">
             ...
             {isAuthenticated && (
                ...
                <h1 className="text-lg font-semibold">{formData.company_name }</h1>
                ...
                <>
                  ...
                  <div className="fixed right-0 top-0 h-screen w-[30%] min-w-[320px] bg-white shadow-2xl z-50 flex flex-col">
                    ...
                    <div className="p-6 border-b flex justify-between items-center">
                      <div>
                        <h2 className="text-lg font-semibold">{formData.company_name || "User"}</h2>
                        <Link
               ...
               {!isAuthenticated && (
                ...
                <div className="relative">
                  ...
                  >
                <span className="text-sm font-medium">For User</span>
